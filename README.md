...
**112** MCP tools · **202** REST endpoints · **22** dashboard pages · **1,962** tests · **25** agent templates · **42** ecosystem research tools · **9** machine-checked invariants
...
- [x] 1,962 automated tests, CI green
