...
_ADVISORY_RULES: list[dict] = [
    ...
    },
    {
        ...
        "category": "meeting",
        "name": "会议触发条件",
        "description": "会议不是前置闸（Council 纪律④，2026-09-16 缔造者裁定改回原意）。减法要留痕：刻意决策回退／砍工具删表／削弱或删除机检红线，走会议或缔造者当场裁定都算数，但结论必须上墙。加法不设闸：新增机检、加严判据、新增工具或表，写清理由直接做。拿不准按减法办。任务墙空不等于该开会，不为有事干而开会",
