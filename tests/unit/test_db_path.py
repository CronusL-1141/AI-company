...
class TestDefaultDbUrl:
    ...
    def test_url_contains_expected_path(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_directory_auto_created(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
