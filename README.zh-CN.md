...
> **Claude Code 是单兵作战工具。AI Team OS 让它具备一整个组织的战斗力。**

---

AI Team OS 是一个叠加在 Claude Code 之上的 **增强层操作系统**，通过 MCP 协议 + Hook 系统 + Agent 模板，将单个 Claude Code 实例变成一支能够自主运转的 AI 团队——有分工、有记忆、能开会、会从每次失败中持续进化。它不是另一个 LLM 框架，而是让 AI 团队**真正像公司一样运转**的基础设施。
