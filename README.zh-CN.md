...
> 📌 **版本说明**：本公开仓库维护在 **v1.6.2** —— 稳定且修复完整的版本（安装器、插件清单、Dashboard 修复均已包含）。更新的开发（v1.7.0+：CC ultracode 工作流观测层、相位泳道、Dashboard 改版等）在私有仓库继续进行。**想获取新版本？联系 [gl2980@nyu.edu](mailto:gl2980@nyu.edu)。**
